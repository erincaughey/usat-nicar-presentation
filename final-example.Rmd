...
**Background:** I went to Marquette Univeristy and my freshman year was Jimmy Butler's final season (the 2010-11 season was awesome!)

So this is the data we'll work with: 

### Marquette data for the 2010-2011 season
...
And the game logs for each individual player: 
...
+ data: [All team game logs for the 2018-19 season](https://github.com/mattwaite/NICAR19SportsDataViz)
...
# optional library but could be useful for plotting later
...
These are gamelogs for [Marquette University's 2010-11 season](https://www.sports-reference.com/cbb/schools/marquette/2011-gamelogs.html). There's an option to download **"Get Table as CSV"**, copy the text on the page, paste into a text editor and then save the file as `mu-10-11-gamelong.csv`
...
```
That's 33 records. Or 33 games. And from our `player_totals` dataframe we know that he played a total of 37 games. Simple math to average: `33 / 37 = .8918919` or of the 37 games Darius Johnson-Odom played he scored 10 points or more in 89% of those games.
